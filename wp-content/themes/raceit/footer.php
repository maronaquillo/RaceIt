<footer id="footer">
		<section class="clients">
			<ul>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-ja.gif" alt="J &amp; A Racing" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-rr.gif" alt="Rock and Roll Marathon" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-portland.gif" alt="Portland Marathon" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-mcm.gif" alt="Marie Corps Marathon" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-sbackers.gif" alt="Sportsbackers" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-army.gif" alt="Army Ten Miler" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-challenge.gif" alt="Challenge Family" border="0"></a></li>
				<li><a href="#" target="_blank"><img src="<?php echo get_template_directory_uri() ?>/images/logos/client-logo-nf.gif" alt="North Face Endurance Challenge" border="0"></a></li>
			</ul>
		</section>
		...
		<section class="footMain">
			<div class="col-md-2 footLogo">
				<p><a href="/"><img src="<?php echo get_template_directory_uri() ?>/images/foot-logo.png" alt="Race IT" border="0"></a></p>
