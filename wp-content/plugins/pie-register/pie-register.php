...
<?php
	...
	function addAddress($field,$no)
	{
		...
		$id 	= $this->createFieldID($field,$no);
		 ...
		 $hideAddress1= "";
		 if(isset($field['hide_address1']) && $field['hide_address1'])
		 {
			$hideAddress1 = 'style="display:none;"';	 
		 }	
		 $hideAddress3= "";
		 if(isset($field['hide_address3']) && $field['hide_address3'])
		 {
			$hideAddress3 = 'style="display:none;"';	 
		 }	
		 $hideAddress4= "";
		 if(isset($field['hide_address4']) && $field['hide_address4'])
		 {
			$hideAddress4 = 'style="display:none;"';	 
		 }	
		...
		echo '<input type="hidden" id="default_'.$field['type'].'">';
		echo '<div class="address" id="address_address1_'.$no.'" '.$hideAddress1.'>
		  <input disabled="disabled" type="text" class="input_fields">
		  <label>'.__("Street Address","piereg").'</label>
		</div>
		<div class="address" id="address_address2_'.$no.'" '.$hideAddress2.'>
		  <input disabled="disabled" type="text" class="input_fields">
		  <label>'.__("Address Line 2","piereg").'</label>
		</div>
		<div class="address">
		  <div class="address2" id="address_address3_'.$no.'" '.$hideAddress3.'>
			<input disabled="disabled" type="text" class="input_fields">
		...
		echo ' <div class="address2" '.$hideAddress2.' id="address_address4_'.$no.'">
			<input disabled="disabled" type="text" class="input_fields">
